...
public class FaceShapeAdapter extends
    ...
    public FaceShapeAdapter(String[] faceShape, Context context) {
...
//        this.context = parent.getContext();
        faceShapeSelected = (OnFaceShapeSelected) context;
    ...
    public void onBindViewHolder(@NonNull FaceShapeHolder holder, int position) {
        ...
        holder.faceShapePreview.setImageResource(DreaProfileSetupUtils.getFaceShape(faceShape[position], context));
    }
