...
public class ProfileSetupUtils {
    ...
    public static final Drawable getComplextionResourceImage(String complextion, Context context) {
        switch (complextion) {
            case COMPLEXTION_DARK:
                return context.getResources().getDrawable(R.drawable.dark_skin_background);
            case COMPLEXTION_BROWN:
                return context.getResources().getDrawable(R.drawable.brown_skin_background);
            case COMPLEXTION_WHITE:
                return context.getResources().getDrawable(R.drawable.white_skin_background);
            default:
                return context.getResources().getDrawable(R.drawable.brown_skin_background);
        }
    }
